...
public class List {
    ...
    */
     ...
     */
    /**
     * To find the size of the given list.
     *
     * @return     an integer:value = size of list.
     */
    public int size() {
     ...
     */
    /**
     * Gets the element of corresponding index.
     *
     * @param      index  The index.
     *
     * @return     a String or a index value.
     */
     ...
     */
    /**
     * To check if the array contains the given item.
     *
     * @param      item  The item.
     *
     ...
     * @param      item  The item.
     *
     * @return     index of the item entered.
     */
